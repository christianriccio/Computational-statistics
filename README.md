...
![formula](https://render.githubusercontent.com/render/math?math=x_{k}  ) ![formula](https://render.githubusercontent.com/render/math?math=_{+ 1}  ) = ![formula](https://render.githubusercontent.com/render/math?math=x_{k}  ) + ![formula](https://render.githubusercontent.com/render/math?math=alpha_{k}  ) * ![formula](https://render.githubusercontent.com/render/math?math=p_{k}  )
